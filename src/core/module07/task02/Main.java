...
public class Main {
    public static void main(String[] args) {
        List<Order> orders = Arrays.asList(
                ...
                new Order(10, 11100, core.module07.Currency.UAH, "Lamp0", "Godman Store0", new User(1110, "Bob0", "Marley0", "Kiev", 1000)),
                new Order(11, 12200, core.module07.Currency.USD, "Lamp1", "Godman Store222", new User(1111, "Bob1", "Marley1", "Rovno", 1001)),
                ...
                new Order(16, 12200, core.module07.Currency.USD, "Lamp6", "Godman Store6", new User(1116, "Bob6", "Marley6", "Kiev", 1006)),
                new Order(137, 200, core.module07.Currency.UAH, "Lamp7", "Godman Store7", new User(1117, "Bob7", "Marley7", "Kamyzyak", 1007)),
                new Order(173, 20, core.module07.Currency.UAH, "Lamp7", "Godman Store7", new User(1117, "Bob7", "Marley7", "Kamyzyak", 1007)),
                new Order(17, 22200, core.module07.Currency.UAH, "Lamp7", "Godman Store7", new User(1117, "Bob7", "Marley7", "Kamyzyak", 1007)),
                new Order(18, 11, core.module07.Currency.USD, "Lamp8", "Godman Store8", new User(1118, "Bob8", "Marley8", "Rovno", 1008)),
                new Order(18, 11, core.module07.Currency.USD, "Lamp8", "Godman Store8", new User(1118, "Bob8", "Petrov", "Rovno", 1008))
        );
/*
...
*//*
        ...
        for (Order order : orders)
            if (order.getCurrency().equals(core.module07.Currency.UAH))
